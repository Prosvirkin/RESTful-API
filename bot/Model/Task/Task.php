<?php
namespace Base\Taskbot\Model\Task;
...
/**
 * @Entity(repositoryClass="Base\Taskbot\Model\Task\TaskRepository")
 * @Table(name="task")
 */
class Task{
  /**
  ...
  /**
   * @ManyToMany(targetEntity="Base\Taskbot\Model\Mark\Mark")
  ...
  /**
   * @ManyToMany(targetEntity="Base\Taskbot\Model\User\User")
